...
var URL string = `https://www.cvedetails.com/vulnerability-list.php?vendor_id=0&product_id=0&version_id=0&page=1&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=` + CVSSSCOREMIN + `&cvssscoremax=0&year=` + YEAR + `&month=` + MONTH + `&cweid=0&order=` + CVE_SCORE_DES + `&trc=819&sha=e0d67584fe23fbc6f5d20e6a4c010e4f62c16c3b`
